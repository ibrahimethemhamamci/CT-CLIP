...
class VideoTextDataset(Dataset):
    ...
    def prepare_samples(self):
        ...
        with open(file_path, "r") as file:
            ...
            for nii_file in lines:
                ...
                nii_lowres="scratch/cvivit-infer/"+nii_lowres+"/"+nii_lowres_img+".nii.gz"
    ...
    def __getitem__(self, index):
        ...
        return self.cast_num_frames_fn(video_lowres), self.cast_num_frames_fn(video_tensor), input_text, patient_info
